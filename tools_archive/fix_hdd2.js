...
// Re-read from scratch_hdd.js to get a fresh copy of the HDD code to fix the broken parts
let hdd = fs.readFileSync("scratch_hdd.js", "utf8");

// Trim the applyExplosion logic
const end = hdd.indexOf("function applyExplosion");
if (end !== -1) {
  hdd = hdd.substring(0, end);
}

// Replace registerModule calls correctly
...
// Remove the registerModule function definition
